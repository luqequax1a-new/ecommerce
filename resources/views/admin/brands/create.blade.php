        ...
        <div class=\"grid grid-cols-1 lg:grid-cols-3 gap-6\">
            ...
            <div class=\"lg:col-span-2 space-y-6\">
                ...
                <div class=\"bg-white shadow rounded-lg p-6\">
                    ...
                    <div class=\"space-y-4\">
                        <div>
                            <label for=\"name\" class=\"block text-sm font-medium text-gray-700\">Marka Adı *</label>
                        ...
                        <div>
                            ...
                            @error('slug')
                                <p class=\"mt-1 text-sm text-red-600\">{{ $message }}</p>
                            @enderror
                            <p class=\"mt-1 text-sm text-gray-500\">Boş bırakılırsa marka adından otomatik oluşturulur.</p>
                        </div>
            ...
            <div class=\"space-y-6\">
                <!-- Brand Settings -->
                <div class=\"bg-white shadow rounded-lg p-6\">
                    <h3 class=\"text-lg font-medium text-gray-900 mb-4\">Marka Ayarları</h3>
